...
const Login = () => {
  const { loginWithEmail} = useContext(AuthContex)
  ...
  return (
    <div className="bg-white rounded-lg shadow sm:max-w-md sm:w-full sm:mx-auto sm:overflow-hidden mt-14">
                    <h3 className="text-center text-5xl font-bold text-orange-500"> Login </h3>
            ...
            <div className="w-full space-y-6">
              ...
              <div className="w-full">
                <div className=" relative">
                  ...
                  <label className="lable"><LoadCanvasTemplate /></label>
                  <input
